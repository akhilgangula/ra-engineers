                            ...
                            <div className="card-body">
                                    ...
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            ...
                                            <input type="text" type='password' className="form-control" value={this.state.password} placeholder="Autogenerated" disabled onChange={(event)=>this.setState({password: event.target.value})} required/>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-3">
                                        ...
                                        <div className="col-sm-12">
                                            ...
                                            <img src={avatar1} className="avatar" onClick={this.selectAvatar}/>
                                            <img src={avatar2} className="avatar" onClick={this.selectAvatar}/>
                                            <img src={avatar3} className="avatar" onClick={this.selectAvatar}/>
                                            <img src={avatar4} className="avatar" onClick={this.selectAvatar}/>
